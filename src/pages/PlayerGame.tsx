...
import AiTestPanel from "@/components/game-shell/AiTestPanel";
...
const PlayerGame = () => {
  ...
  const load = useCallback(async () => {
    ...
    const [{ data: gData }, { data: pData }, { data: prData }, { data: ftData }, { data: stData }] = await Promise.all([
      ...
      (supabase as any).from("ship_types").select("id, name, hull_class, ship_id, class, point_cost, maintenance, map_speed, repair_pod, supply_pod, hull"),
    ]);
